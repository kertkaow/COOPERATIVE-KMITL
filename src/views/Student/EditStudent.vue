<template>
    <div class="row justify-content-center">
        <div class="col-md-6 bgbd">
            <!-- Content goes here -->
            <h1 class="d-flex justify-content-center formtitle-1">แก้ไขข้อมูล</h1>
            <form @submit.prevent="updateStudent">
                ...
                <!-- ปุ่มลงทะเบียน -->
                <div class="form-group">
                    <button class="btn submit-btn col-12 mt-3">บันทึกข้อมูล</button>
                </div>                       
                </div>
            </form>
        </div>
...
import { getDoc, getDocs, query, where, doc, updateDoc,serverTimestamp } from 'firebase/firestore'
