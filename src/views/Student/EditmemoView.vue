<template>
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 bgbd">
            <!-- Content goes here -->
            <h1 class="d-flex justify-content-center formtitle-1">[ {{ Matchings.firstName }} {{ Matchings.lastName }} ] รหัสนักศึกษา : [ {{ Matchings.studentID }} ] บริษัท : [ {{ Matchings.Name}} ] โครงการ : [ {{ Matchings.projectName }} ]</h1>
