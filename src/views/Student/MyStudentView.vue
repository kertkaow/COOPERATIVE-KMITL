                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="student in Students" :key="student.id">
                                 <td>
                                   <router-link :to="{ path: `/StudentDetails/${student.id}` }" class="btn btn-primary d-flex justify-content-center Info-btn">
                                         ข้อมูลนักศึกษา
                                    </router-link>
                                 </td>
                                 ...
                                 <td>
                                    <router-link class="text-decoration-none" style="color: black;" :to="{ path: `/CompanyDetails/${student.firstChoice.companyId}` }">{{ student.firstChoice.companyNameAndProjectName }}</router-link>
                                 ...
                                 <td>
                                    <router-link class="text-decoration-none" style="color: black;" :to="{ path: `/CompanyDetails/${student.secondChoice.companyId}` }">{{ student.secondChoice.companyNameAndProjectName }}</router-link>
                                 ...
                                 <td>
                                    <router-link class="text-decoration-none" style="color: black;" :to="{ path: `/CompanyDetails/${student.thirdChoice.companyId}` }">{{ student.thirdChoice.companyNameAndProjectName }}</router-link>
                                 ...
                                 <td>
                                    ...
                                    <router-link :to="{ path: `/EditStudent/${student.id}` }" v-if="student.companyConfirm != true" class="text-decoration-none btn edit-btn" style="color:white;">
                                    แก้ไขข้อมูล   
                                    </router-link>
                                  </td>
                            </tr>
