<template>
    <div class="row justify-content-center">
        <div class="col-md-6 bgbd">
            <!-- Content goes here -->
            <h1 class="d-flex justify-content-center formtitle-1">แก้ไขบริษัทของนักศึกษาชื่อ : [ {{ Students.firstName }} {{ Students.lastName }} ]  รหัสนักศึกษา : [ {{ Students.studentID }} ]</h1>
...
import { getDoc, getDocs, query, where, doc, serverTimestamp, updateDoc } from 'firebase/firestore'
